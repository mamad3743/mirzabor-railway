...
# ---- Apache config ----
# mod_php requires prefork. Remove every enabled MPM first, then enable only
# prefork. The same cleanup is repeated in entrypoint.sh because Railway may
# reuse a cached image/layer and Apache must be valid at runtime too.
